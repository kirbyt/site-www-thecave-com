...
# Derived from the Jekyll category page generator.
...
# also create a file called 'tab_index.html' in the _layouts directory of your jekyll site
...
# - tag_dir:          The subfolder to build tags pages in (default is 'tags').
  ...
  class TagPage < Page
    ...
    def initialize(template_path, name, site, base, tag_dir, tag)
      ...
      if File.exist?(template_path)
        ...
        # KT: Commented out the following. Not needed for thecave.com.
